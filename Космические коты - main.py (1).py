...
space = pg.image.load("Fon.png").convert()
...
text_number = 0
f1 = pg.font.Font("fint.otf", 25)

pg.mixer.music.load("tense.wav")
pg.mixer.music.set_volume(0.2)
pg.mixer.music.play()

laser_sound = pg.mixer.Sound("ice.wav")
win_sound = pg.mixer.Sound("winn.wav")
